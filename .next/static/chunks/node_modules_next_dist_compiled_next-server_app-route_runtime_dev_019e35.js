(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_next_dist_compiled_next-server_app-route_runtime_dev_019e35.js", {

"[project]/node_modules/next/dist/compiled/next-server/app-route.runtime.dev.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    var __webpack_modules__ = {
        ...
        "./dist/compiled/react/cjs/react.development.js": (module1, exports, __webpack_require__)=>{
            "use strict";
            module1 = __webpack_require__.nmd(module1), function() {
                ...
                function describeNativeComponentFrame(fn, construct) {
                    ...
                    previousDispatcher = ReactSharedInternals.H, ReactSharedInternals.H = null, function() {
                        if (0 === disabledDepth) {
                    ...
                    try {
                        ...
                        if (sampleStack && controlStack) {
                            ...
                            for(; 1 <= namePropDescriptor && 0 <= _RunInRootFrame$Deter; namePropDescriptor--, _RunInRootFrame$Deter--)if (sampleLines[namePropDescriptor] !== controlLines[_RunInRootFrame$Deter]) {
                                if (1 !== namePropDescriptor || 1 !== _RunInRootFrame$Deter) do if (namePropDescriptor--, _RunInRootFrame$Deter--, 0 > _RunInRootFrame$Deter || sampleLines[namePropDescriptor] !== controlLines[_RunInRootFrame$Deter]) {
                                    var _frame = "\n" + sampleLines[namePropDescriptor].replace(" at new ", " at ");
                                    return fn.displayName && _frame.includes("<anonymous>") && (_frame = _frame.replace("<anonymous>", fn.displayName)), "function" == typeof fn && componentFrameCache.set(fn, _frame), _frame;
                                }
                        ...
                        reentry = !1, ReactSharedInternals.H = previousDispatcher, function() {
                            if (0 == --disabledDepth) {
                                var props = {
                                    configurable: !0,
                                    enumerable: !0,
                    ...
                    return sampleLines = (sampleLines = fn ? fn.displayName || fn.name : "") ? describeBuiltInComponentFrame(sampleLines) : "", "function" == typeof fn && componentFrameCache.set(fn, sampleLines), sampleLines;
                }
                function getOwner() {
                ...
                function validateChildKeys(node, parentType) {
                    if ("object" == typeof node && node && node.$$typeof !== REACT_CLIENT_REFERENCE) {
                        ...
                        else if ("function" == typeof (i = getIteratorFn(node)) && i !== node.entries && (i = i.call(node)) !== node) for(; !(node = i.next()).done;)isValidElement(node.value) && validateExplicitKey(node.value, parentType);
                    }
                }
                ...
                function validateExplicitKey(element, parentType) {
                    if (element._store && !element._store.validated && null == element.key && (element._store.validated = 1, !ownerHasKeyUseWarning[parentType1 = parentType, info = "", (owner = getOwner()) && (owner = getComponentNameFromType(owner.type)) && (info = "\n\nCheck the render method of `" + owner + "`."), info || (parentType1 = getComponentNameFromType(parentType1)) && (info = "\n\nCheck the top-level render call using <" + parentType1 + ">."), parentType = info])) {
                        ownerHasKeyUseWarning[parentType] = !0;
                        var parentType1, info, owner, childOwner = "";
                        element && null != element._owner && element._owner !== getOwner() && (childOwner = null, "number" == typeof element._owner.tag ? childOwner = getComponentNameFromType(element._owner.type) : "string" == typeof element._owner.name && (childOwner = element._owner.name), childOwner = " It was passed a child from " + childOwner + ".");
                        var prevGetCurrentStack = ReactSharedInternals.getCurrentStack;
                        ReactSharedInternals.getCurrentStack = function() {
                            var stack = function describeUnknownElementTypeFrameInDEV(type) {
                                if (null == type) return "";
                                ...
                                if ("object" == typeof type) switch(type.$$typeof){
                                    case REACT_FORWARD_REF_TYPE:
                                        return type = describeNativeComponentFrame(type.render, !1);
                                    case REACT_MEMO_TYPE:
                                        return describeUnknownElementTypeFrameInDEV(type.type);
                                    case REACT_LAZY_TYPE:
                                        prototype = type._payload, type = type._init;
                                        try {
                            ...
                            return prevGetCurrentStack && (stack += prevGetCurrentStack() || ""), stack;
                        }, console.error('Each child in a list should have a unique "key" prop.%s%s See https://react.dev/link/warning-keys for more information.', parentType, childOwner), ReactSharedInternals.getCurrentStack = prevGetCurrentStack;
                    }
                }
                ...
                var prevLog, prevInfo, prevWarn, prevError, prevGroup, prevGroupCollapsed, prevGroupEnd, isArrayImpl = Array.isArray, REACT_CLIENT_REFERENCE$2 = Symbol.for("react.client.reference"), ReactSharedInternals = {
                    H: null,
                    A: null,
                    T: null,
                    S: null,
                ...
                }, hasOwnProperty = Object.prototype.hasOwnProperty, REACT_CLIENT_REFERENCE$1 = Symbol.for("react.client.reference"), disabledDepth = 0;
                disabledLog.__reactDisabledLog = !0;
                var prefix, suffix, specialPropKeyWarningShown, didWarnAboutOldJSXRuntime, reentry = !1, componentFrameCache = new ("function" == typeof WeakMap ? WeakMap : Map), REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference"), didWarnAboutElementRef = {}, ownerHasKeyUseWarning = {}, didWarnAboutMaps = !1, userProvidedKeyEscapeRegex = /\/+/g, reportGlobalError = "function" == typeof reportError ? reportError : function(error) {
                ...
                exports.Children = {
                    ...
                    for(props = ReactElement(element.type, key, void 0, void 0, owner, props), key = 2; key < arguments.length; key++)validateChildKeys(arguments[key], props.type);
                    return props;
                    ...
                    if (isValidElementType(type)) for(var propName, i = 2; i < arguments.length; i++)validateChildKeys(arguments[i], type);
                    else {
                        if (i = "", (void 0 === type || "object" == typeof type && null !== type && 0 === Object.keys(type).length) && (i += " You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports."), null === type) var typeString = "null";
                    ...
                    return typeString && function(props, displayName) {
                    ...
                    }(i, "function" == typeof type ? type.displayName || type.name || "Unknown" : type), ReactElement(type, typeString, void 0, void 0, getOwner(), i);
                    ...
                    var ownName;
                    return isValidElementType(type) || console.error("memo: The first argument must be a component. Instead received: %s", null === type ? "null" : typeof type), Object.defineProperty(compare = {
                ...
                }, exports.version = "19.0.0-rc-66855b96-20241106", "undefined" != typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" == typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(Error());
            }();
        },
        "./dist/compiled/react/index.js": (module1, __unused_webpack_exports, __webpack_require__)=>{
            "use strict";
...
Original Message: ${message}`);
        ...
        let action_async_storage_external_js_namespaceObject = __turbopack_require__("[project]/node_modules/next/dist/server/app-render/action-async-storage.external.js [app-client] (ecmascript)"), AppRouterContext = react_default().createContext(null), LayoutRouterContext = react_default().createContext(null), GlobalLayoutRouterContext = react_default().createContext(null), TemplateContext = react_default().createContext(null);
        ...
        let wellKnownProperties = new Set([
            ...
            current: null
        }, cache = "function" == typeof react.cache ? react.cache : (fn)=>fn, logErrorOrWarn = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : console.warn, flushCurrentErrorIfNew = cache((key)=>{
            try {
...
//# sourceMappingURL=node_modules_next_dist_compiled_next-server_app-route_runtime_dev_019e35.js.map