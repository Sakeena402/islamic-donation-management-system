(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_next_dist_server_base-server_9fcee7.js", {

"[project]/node_modules/next/dist/server/base-server.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
const _utils2 = __turbopack_require__("[project]/node_modules/next/dist/server/utils.js [app-client] (ecmascript)");
...
const _localeroutenormalizer = __turbopack_require__("[project]/node_modules/next/dist/server/normalizers/locale-route-normalizer.js [app-client] (ecmascript)");
...
const _apppageroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/app-page-route-matcher-provider.js [app-client] (ecmascript)");
const _approuteroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/app-route-route-matcher-provider.js [app-client] (ecmascript)");
const _pagesapiroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/pages-api-route-matcher-provider.js [app-client] (ecmascript)");
const _pagesroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/pages-route-matcher-provider.js [app-client] (ecmascript)");
const _servermanifestloader = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/helpers/manifest-loaders/server-manifest-loader.js [app-client] (ecmascript)");
...
const _i18nprovider = __turbopack_require__("[project]/node_modules/next/dist/server/lib/i18n-provider.js [app-client] (ecmascript)");
const _sendresponse = __turbopack_require__("[project]/node_modules/next/dist/server/send-response.js [app-client] (ecmascript)");
const _utils3 = __turbopack_require__("[project]/node_modules/next/dist/server/web/utils.js [app-client] (ecmascript)");
const _constants2 = __turbopack_require__("[project]/node_modules/next/dist/lib/constants.js [app-client] (ecmascript)");
...
const _matchnextdatapathname = __turbopack_require__("[project]/node_modules/next/dist/server/lib/match-next-data-pathname.js [app-client] (ecmascript)");
...
const _decodepathparams = __turbopack_require__("[project]/node_modules/next/dist/server/lib/router-utils/decode-path-params.js [app-client] (ecmascript)");
const _rsc = __turbopack_require__("[project]/node_modules/next/dist/server/normalizers/request/rsc.js [app-client] (ecmascript)");
const _stripflightheaders = __turbopack_require__("[project]/node_modules/next/dist/server/app-render/strip-flight-headers.js [app-client] (ecmascript)");
...
const _serveractionrequestmeta = __turbopack_require__("[project]/node_modules/next/dist/server/lib/server-action-request-meta.js [app-client] (ecmascript)");
...
const _patchsetheader = __turbopack_require__("[project]/node_modules/next/dist/server/lib/patch-set-header.js [app-client] (ecmascript)");
...
const _adapter = __turbopack_require__("[project]/node_modules/next/dist/server/web/adapter.js [app-client] (ecmascript)");
const _utils4 = __turbopack_require__("[project]/node_modules/next/dist/server/instrumentation/utils.js [app-client] (ecmascript)");
...
const _utils5 = __turbopack_require__("[project]/node_modules/next/dist/server/response-cache/utils.js [app-client] (ecmascript)");
const _scheduler = __turbopack_require__("[project]/node_modules/next/dist/lib/scheduler.js [app-client] (ecmascript)");
const _resumedatacache = __turbopack_require__("[project]/node_modules/next/dist/server/resume-data-cache/resume-data-cache.js [app-client] (ecmascript)");
...
class Server {
   ...
   */ constructor(options){
        ...
        this.handleNextDataRequest = async (req, res, parsedUrl)=>{
            ...
            if (params.path[0] !== this.buildId) {
                ...
                if (("TURBOPACK compile-time value", "") !== 'edge' && (0, _requestmeta.getRequestMeta)(req, 'middlewareInvoke')) {
                    return false;
                }
   ...
   */ this.normalize = (pathname)=>{
        ...
        this.dir = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : __turbopack_require__("[project]/node_modules/next/dist/compiled/path-browserify/index.js [app-client] (ecmascript)").resolve(dir);
        this.quiet = quiet;
        this.loadEnvConfig({
            dev
        });
        ...
        this.port = port;
        this.distDir = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : __turbopack_require__("[project]/node_modules/next/dist/compiled/path-browserify/index.js [app-client] (ecmascript)").join(this.dir, this.nextConfig.distDir);
        ...
        this[minimalModeKey] = minimalMode || !!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PRIVATE_MINIMAL_MODE;
    ...
    async handleRequestImpl(req, res, parsedUrl) {
        try {
            ...
            if (useMatchedPathHeader) {
                try {
                    ...
                    if ((_this_normalizers_data = this.normalizers.data) == null ? void 0 : _this_normalizers_data.match(urlPathname)) {
                        ...
                        const postponed = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat(body).toString('utf8');
            ...
            const useInvokePath = !useMatchedPathHeader && ("TURBOPACK compile-time value", "") !== 'edge' && invokePath;
            if (useInvokePath) {
   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
        ...
        const hasDebugStaticShellQuery = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.__NEXT_EXPERIMENTAL_STATIC_SHELL_DEBUGGING === '1' && typeof query.__nextppronly !== 'undefined' && couldSupportPPR;
        ...
        if (hasServerProps || isSSG || isAppPath) {
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                const { tryGetPreviewData } = __turbopack_require__("[project]/node_modules/next/dist/server/api-utils/node/try-get-preview-data.js [app-client] (ecmascript)");
        ...
        const doRender = async ({ postponed, fallbackRouteParams })=>{
            ...
            if (routeModule) {
                if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
                    ...
                    ("TURBOPACK compile-time value", "") === 'edge' || !(0, _helpers.isNodeNextRequest)(req) || !(0, _helpers.isNodeNextResponse)(res)) {
                        ...
                        if (isSSG) {
                            ...
                            const cacheEntry = {
                                value: {
                                    ...
                                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(await blob.arrayBuffer()),
                                    headers
                                },
                                revalidate,
                                isFallback: false
        ...
        let responseGenerator = async ({ hasResolved, previousCacheEntry, isRevalidating })=>{
            ...
            //
            if (("TURBOPACK compile-time value", "") !== 'edge' && !this.minimalMode && fallbackMode !== _fallback.FallbackMode.BLOCKING_STATIC_RENDER && staticPathKey && !didRespond && !isPreviewMode && isDynamic && (isProduction || !staticPaths || !isPageIncludedInStaticPaths)) {
                if (// getStaticPaths.
        ...
        // the route shell.
        !isDebugFallbackShell && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.DISABLE_ROUTE_SHELL_GENERATION !== 'true') {
    ...
    async renderToResponseImpl(ctx) {
        ...
        try {
            ...
            if (!isWrappedError) {
                if (this.minimalMode && ("TURBOPACK compile-time value", "") !== 'edge' || this.renderOpts.dev) {
...
//# sourceMappingURL=node_modules_next_dist_server_base-server_9fcee7.js.map