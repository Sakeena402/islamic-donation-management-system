(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_90e2b1._.js", {
...
"[project]/app/(auth-pages)/verifyemail/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function VerifyEmailPage() {
    ...
    const [email, setEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // Store email for resend
    ...
    const verifyUserEmail = async ()=>{
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/auth/verifyemail", {
                token
            });
            router.push("/login");
        } catch (error) {
    ...
    const resendVerificationEmail = async ()=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/auth/resend-verification", {
                email
            });
 ...
 //   );
 // }
_s(VerifyEmailPage, "AHLUv+KyFL/K5HIHA9i7BSvKbpI=", false, function() {
    return [
...
"[project]/app/(auth-pages)/verifyemail/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_90e2b1._.js.map