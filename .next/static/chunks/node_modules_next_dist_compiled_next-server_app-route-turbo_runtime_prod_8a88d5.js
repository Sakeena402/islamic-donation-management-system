(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_next_dist_compiled_next-server_app-route-turbo_runtime_prod_8a88d5.js", {

"[project]/node_modules/next/dist/compiled/next-server/app-route-turbo.runtime.prod.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ 
            ...
            function y(e, t, r) {
                this.props = e, this.context = t, this.refs = g, this.updater = r || f;
            }
            function v() {}
            function b(e, t, r) {
                this.props = e, this.context = t, this.refs = g, this.updater = r || f;
                        ...
                        case "object":
                            switch(t.$$typeof){
                                ...
                                case n:
                                    ...
                                    break;
                                case h:
                                    return e((f = t._init)(t._payload), o, s, i, a);
                            }
                    }
                    if (f) return a = a(t), f = "" === i ? "." + P(t, 0) : i, x(a) ? (s = "", null != f && (s = f.replace(E, "$&/") + "/"), e(a, o, s, "", function(e) {
                        return e;
                    })) : null != a && (R(a) && (l = a, u = s + (null == a.key || t && t.key === a.key ? "" : ("" + a.key).replace(E, "$&/") + "/") + f, a = C(l.type, u, void 0, void 0, void 0, l.props)), o.push(a)), 1;
                    f = 0;
                    var m = "" === i ? "." : i + ":";
                    if (x(t)) for(var g = 0; g < t.length; g++)d = m + P(i = t[g], g), f += e(i, o, s, d, a);
                    else if ("function" == typeof (g = null === (c = t) || "object" != typeof c ? null : "function" == typeof (c = p && c[p] || c["@@iterator"]) ? c : null)) for(t = g.call(t), g = 0; !(i = t.next()).done;)d = m + P(i = i.value, g++), f += e(i, o, s, d, a);
                    else if ("object" === d) {
            ...
            t.Children = {
            ...
            }, t.Component = y, t.Fragment = o, t.Profiler = i, t.PureComponent = b, t.StrictMode = s, t.Suspense = c, t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = S, t.act = function() {
                ...
                var n = m({}, e.props), o = e.key, s = void 0;
                if (null != t) for(i in void 0 !== t.ref && (s = void 0), void 0 !== t.key && (o = "" + t.key), t)_.call(t, i) && "key" !== i && "__self" !== i && "__source" !== i && ("ref" !== i || void 0 !== t.ref) && (n[i] = t[i]);
                ...
                return C(e.type, o, void 0, void 0, s, n);
                ...
                var n, o = {}, s = null;
                if (null != t) for(n in void 0 !== t.key && (s = "" + t.key), t)_.call(t, n) && "key" !== n && "__self" !== n && "__source" !== n && (o[n] = t[n]);
                var i = arguments.length - 2;
                if (1 === i) o.children = r;
                else if (1 < i) {
                    for(var a = Array(i), l = 0; l < i; l++)a[l] = arguments[l + 2];
                ...
                return C(e, s, void 0, void 0, null, o);
                ...
                try {
                    var n = e(), o = S.S;
                    null !== o && o(r, n), "object" == typeof n && null !== n && "function" == typeof n.then && n.then(N, O);
                } catch (e) {
                    O(e);
                } finally{
                    S.T = t;
    ...
    (()=>{
        ...
        var en = r("./dist/compiled/react/index.js");
        ...
        class eP {
            ...
            analyze() {
                ...
                let s = function(e, t) {
                    ...
                    o && eS(a.pathname, o) && (a.pathname = function(e, t) {
                        if (!eS(e, t)) return e;
                    ...
                    if (s) {
                        let e = t.i18nProvider ? t.i18nProvider.analyze(a.pathname) : e_(a.pathname, s.locales);
                        a.locale = e.detectedLocale, a.pathname = null != (n = e.pathname) ? n : a.pathname, !e.detectedLocale && a.buildId && (e = t.i18nProvider ? t.i18nProvider.analyze(l) : e_(l, s.locales)).detectedLocale && (a.locale = e.detectedLocale);
                    }
                    return a;
            ...
            formatPathname() {
                ...
                return t = function(e, t, r, n) {
                    if (!t || t === r) return e;
                    let o = e.toLowerCase();
                    return !n && (eS(o, "/api") || eS(o, "/" + t.toLowerCase())) ? e : ew(e, "/" + t);
                }((e = {
...
Original Message: ${r}`);
        ...
        class te extends _ {
            ...
            async do(e, t, r, n, o, i, a) {
                    ...
                    globalThis.fetch = function(e, { workAsyncStorage: t, workUnitAsyncStorage: r }) {
                        let n = async (n, o)=>{
                            ...
                            let w = (0, H.getTracer)().trace(h ? s.internalFetch : l.fetch, {
                                ...
                                let S = v && "unstable-cache" !== v.type ? v.implicitTags : [], _ = v && "unstable-cache" === v.type ? "force-no-store" : y.fetchCache, C = !!y.isUnstableNoStore, R = u("cache"), E = "";
                                ...
                                let P = "no-cache" === R || "no-store" === R || "force-no-store" === _ || "only-no-store" === _, T = !_ && !R && !p && y.forceDynamic;
                                ...
                                let k = u("headers"), A = "function" == typeof (null == k ? void 0 : k.get) ? k : new Headers(k || {}), O = A.get("authorization") || A.get("cookie"), N = ![
                                    "get",
                                    "head"
                                ].includes((null == (t = u("method")) ? void 0 : t.toLowerCase()) || "get"), I = void 0 == _ && (void 0 == R || "default" === R) && void 0 == p, $ = I && !y.isPrerendering || (O || N) && x && 0 === x.revalidate;
                                ...
                                if (void 0 === a ? "default-cache" !== _ || C ? "default-no-store" === _ ? (a = 0, E = "fetchCache = default-no-store") : C ? (a = 0, E = "noStore call") : $ ? (a = 0, E = "auto no cache") : (E = "auto cache", a = x ? x.revalidate : 4294967294) : (a = 4294967294, E = "fetchCache = default-cache") : E || (E = `revalidate: ${a}`), !(y.forceStatic && 0 === a) && !$ && x && a < x.revalidate) {
                                    if (0 === a) {
                ...
                let S = new Headers(g.headers);
                return "request" === n.type && j(S, n.mutableCookies) ? new Response(g.body, {
                    status: g.status,
...
//# sourceMappingURL=node_modules_next_dist_compiled_next-server_app-route-turbo_runtime_prod_8a88d5.js.map