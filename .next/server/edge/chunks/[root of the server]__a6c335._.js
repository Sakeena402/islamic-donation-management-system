...
async function middleware(request) {
    ...
    if (token) {
        try {
            const { role } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$helpers$2f$getDataFromToken$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["getDataFromToken"])(token);
            userRole = role;
        } catch (error) {
