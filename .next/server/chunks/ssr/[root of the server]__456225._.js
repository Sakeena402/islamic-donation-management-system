...
const LoginPage = ()=>{
    ...
    const onLogin = async (credentials)=>{
        try {
            ...
            // Extract token from cookies and decode the role
            try {
                const token1 = __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$http$2c$__cjs$29$__["request"].cookies.get("token")?.value || '';
                if (!token1) throw new Error("Token not found");
                const decodedToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].verify(token1, process.env.JWT_SECRET_KEY);
                return {
                    id: decodedToken.id,
            ...
            const { role } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].decode(token.split('=')[1]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__456225._.js.map