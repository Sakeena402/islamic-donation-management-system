...
"[project]/helpers/getDataFromToken.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getDataFromToken = (request)=>{
    try {
        ...
        const decodedToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.TOKEN_SECRET);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$helpers$2f$getDataFromToken$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/helpers/getDataFromToken.ts [app-ssr] (ecmascript)");
...
const LoginPage = ()=>{
    ...
    if (token) {
        try {
            const { role } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$helpers$2f$getDataFromToken$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDataFromToken"])(request);
            userRole = role;
        } catch (error) {
    ...
    const onLogin = async (credentials)=>{
        try {
            ...
            const { id, username } = response.data; // Extract `id` and `username` from response
            console.log("Login successful", {
                id,
                username
            });
            // Redirect to profile page with `id` and `username`
            router.push(`/user/profile/${id}?username=${encodeURIComponent(username)}`);
        } catch (error) {
            if (error.response) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__762295._.js.map